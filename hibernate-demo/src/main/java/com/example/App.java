...
public class App {
    public static void main(String[] args) {
        // Création de l'EntityManagerFactory, EntityManager = session avec la base
    ...
    private static void insertProduits(EntityManagerFactory emf) {
        EntityManager em = emf.createEntityManager();
        try {
            em.getTransaction().begin();

            // Création de quelques produits
            Produit p1 = new Produit("Mac", new BigDecimal("1999.99"));
            Produit p2 = new Produit("Iphone", new BigDecimal("1499.99"));
            Produit p3 = new Produit("Ipad", new BigDecimal("1299.99"));
    ...
    private static void readProduits(EntityManagerFactory emf) {
        EntityManager em = emf.createEntityManager();
        try {
